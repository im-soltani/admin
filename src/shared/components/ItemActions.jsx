...
class ItemActions extends React.Component {
  ...
  _handleAction = () => {
    if (!this.props.update) {
      ...
      this.props
        ...
        .then(() => {
          Alert.success("Les compétences sont ajoutée avec succès");
          this.swithToAdd();
          this.props.refetch();
        })
        .catch(() => {
      ...
      this.props
        ...
        .catch(() => {
          this.setState(
            ...
            () => {
              Alert.warning("Cette compétence existe déjà");
            }
          );
        });
    }
  ...
  _handleExport = () => {
    this.props
      .exportFunc()
      .then((responnse) => {
        console.log("responnse", responnse.data.exportCompetence);
        axios({
    ...
    return (
      <div className={className}>
        <div style={{ position: "relative" }}>
          ...
          <Label className="Items-subheader">
            {!update
              ...
              : `Modifier ${
              label === "métier" ? "un métier" : "une compétence"
              }`}
          </Label>
        </div>
        ...
        <div className="Items-btn__div">
          {label === "métier" ?
            <Button
              onClick={this._handleExportJobs}
              className="Items-btn__success"
              size="lg"
              text={"EXPORTER"}
              color="primary"
