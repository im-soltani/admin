...
class EntreprisesActions extends Component {
  static propTypes = {
              ...
              <Col xs={12} md={12} lg={12} xl={9}>
                <Card>
                  <CardBody className="Email-card__p">
                    ...
                    suspendre l’ensemble des entreprises actuellement actives.
                  </CardBody>
                </Card>
              </Col>
              ...
              <Col xs={12} md={12} lg={12} xl={9}>
                <Card>
                  <CardBody className="Email-card__p">
                    ...
                    activer l’ensemble des entreprises qui ne sont pas actives.
                  </CardBody>
                </Card>
              </Col>
              <Col xs={12} md={12} lg={12} xl={3}>
...
export default graphql(UPDATE_USERS_STATUS)(EntreprisesActions);
