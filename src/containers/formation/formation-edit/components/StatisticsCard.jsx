      ...
      datasets: [
        {
          data: [
            ...
            applications.filter(app => app.state === "APPROVED").length,
            applications.filter(app => app.state === "CALLED_TO_INETRVIEW")
              .length,
            applications.filter(app => app.state === "INETRVIEW_PASSED").length,
