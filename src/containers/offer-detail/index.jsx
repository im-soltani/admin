            ...
            <div className="profile" style={{ paddingTop: 30 }}>
              ...
              <Row>
                <Col md={12} lg={5} xl={4}>
                  <Row>
                    ...
                    />
                    <ProfilCompetences title={"Métiers"} competences={[getOfferByNum.job]} />
                    <ProfilCompetences title={"Softskills"} competences={getOfferByNum.softskills} />
                  </Row>
                </Col>
              ...
              <div className="Button-add__div" title="Modifier">
                <Link
                  ...
                  to={`/modifier-offre/${getOfferByNum.num}`}
                >
