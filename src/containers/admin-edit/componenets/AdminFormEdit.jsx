...
class AdminFormEdit extends React.Component {
  static propTypes = {
            ...
            <Col xs={12} md={12} lg={12} xl={12}>
              <FormGroup>
                ...
                <Input
                  ...
                  name="email"
                  placeholder="Email"
                  defaultValue={admin.profile.email}
...
const EDIT_ADMIN = gql`
  mutation updateAdmin($id: ID!, $file: Upload, $input: AdminAddInput!) {
    updateAdmin(id: $id, file: $file, input: $input) {
      id
    }
  }
`;
export default withRouter(graphql(EDIT_ADMIN)(AdminFormEdit));
