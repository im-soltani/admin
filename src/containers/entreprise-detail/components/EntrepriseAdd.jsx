...
class EntrepriseAdd extends React.Component {
  static propTypes = {
    className: PropTypes.string,
    title: PropTypes.string,
    addEntreprise: PropTypes.func,
        ...
        this.props
          ...
          .then(() => {
            this.onResponse(() => {
              ...
              this.props.history.replace("/entreprises");
            });
          })
          .catch(e => {
            this.onResponse(() => {
                ...
                {youtubeLink && ReactPlayer.canPlay(youtubeLink) ?
                  <Col xs={12} md={12} lg={6} xl={6} style={{ marginBottom: 6, display: "grid", justifyContent: "center" }}>
                    <ReactPlayer
                      ...
                      height={"20rem"}
                    />
                  </Col> : <Col xs={12} md={12} lg={6} xl={6} style={{ marginBottom: 6 }} />
                }
              </Row>
            </ListGroup>
            <div style={{ display: "flex", justifyContent: "center" }}>
...
const ADD_ENTREPRISE = gql`
  mutation addEntreprise($file: Upload!, $input: EntrepriseInput!) {
    addEntreprise(file: $file, input: $input) {
      id
    }
  }
`;
export default withRouter(
  graphql(ADD_ENTREPRISE, {
    name: "addEntreprise"
  })(EntrepriseAdd)
);
